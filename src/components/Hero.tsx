    ...
    <div className="bg-background">
      <div className="container py-20">
        <div className="flex items-center justify-around">
          <div>
            <h3 className="text-tprimary-100 tracking-wide text-sm sm:text-base">
              {t("hi")}
            </h3>
            <h1 className="text-5xl md:text-6xl font-semibold mb-2 tracking-wide">
              Eddy Léon
            </h1>
            <h2 className="text-tprimary-100 text-xl md:text-2xl tracking-wide mb-1 md:mb-2">
              {t("post")}
            </h2>
            <hr className="bg-accent border-none outline-none mb-2 max-w-36 h-[4px]" />
            <p className="max-w-[450px] text-tprimary-200 text-sm md:text-base mb-4 md:mb-6">
              {t("heroDesc")}
            </p>
